...
- Run `pip3 install staticmap geopy Pillow`
...
```
usage: create_map [-h] [--verbose] [-i INFILE] [-o OUTFILE] [-n NAME]
                  [--img_w WIDTH] [--img_h HEIGHT] [-z ZOOM]
...
Arguments:
  ...
  -i INFILE       Address List Table (address.lst)
  -o OUTFILE      PNG file to create (marker.png)
  -n NAME         Your/Company Name (default)
  --img_w WIDTH   Width of the output image (400)
  --img_h HEIGHT  Height of the output image (400)
  -z ZOOM         Image Zoom factor (10)
  ```
...
1 Spokane Lane, Seattle, WA, 98195:red
2401 Utah Ave S, Seattle, WA, 98195:purple:15
```
